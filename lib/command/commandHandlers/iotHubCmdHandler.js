...
module.exports = (function() {
  ...
  var renameHub = function(params) {
    return hubMethod("rename", params);
  };

  var deleteHub = function(params) {
    return hubMethod("delete", params);
  };
  ...
  var processFeedData = function(hubId, feedId, datumList) {
    ...
    self._feedRepo.get([hubId,feedId]).then(function(feed) {
      if (!feed) {
        ...
        var feedDataRepo = getDataRepository(feed).repo; // new Repository(IOTFeedData, { collectionBaseName: feed.store });
